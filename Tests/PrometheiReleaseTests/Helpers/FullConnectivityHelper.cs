...
namespace PrometheiTests.Helpers
{
    ...
    public class FullConnectivityHelper
    {
        ...
        public void AssertFullyConnected(IEnumerable<IPrometheiNode> nodes)
        {
            AssertFullyConnected(nodes.ToArray());
        }

        private void AssertFullyConnected(IPrometheiNode[] nodes)
        {
        ...
        private Entry[] CreateEntries(IPrometheiNode[] nodes)
        {
        ...
        public class Entry
        {
            public Entry(IPrometheiNode node)
            {
                Node = node;
                Response = node.GetDebugInfo();
            }

            public IPrometheiNode Node { get; }
