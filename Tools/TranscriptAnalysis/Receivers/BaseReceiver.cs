...
namespace TranscriptAnalysis.Receivers
{
    public abstract class BaseReceiver<T> : IEventReceiver<T>
    {
        ...
        protected OverwatchPrometheiHeader Header { get; private set; } = null!;
        ...
        public void Init(string sourceFilename, ILog log, OverwatchPrometheiHeader header)
        {
        ...
        protected PrometheiNodeIdentity? GetIdentity(int nodeIndex)
        {
