...
{
    [Serializable]
    public class OverwatchPrometheiHeader
    {
        public PrometheiNodeIdentity[] Nodes { get; set; } = Array.Empty<PrometheiNodeIdentity>();
    }

    [Serializable]
    public class OverwatchPrometheiEvent
    {
    ...
    [Serializable]
    public class PrometheiNodeIdentity
    {
    ...
    #region Promethei Generated Events
